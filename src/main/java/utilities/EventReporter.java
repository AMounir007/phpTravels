...
public class EventReporter implements WebDriverEventListener {
	...
	public void afterAlertAccept(WebDriver driver) {		
		System.out.println("Click On: Alert Accept Done");}
	...
	public void beforeClickOn(WebElement element, WebDriver driver) {
		//System.err.println("Click on Element with tag name: "+element.getTagName());	
		if (element.getTagName()== "button") {
			System.out.println("Click on Element with Text name: "+element.getText());
		}
	}

	@Override
	public void afterClickOn(WebElement element, WebDriver driver) {		
		//System.err.println("Click Done on Element with tag name: "+element.getTagName());	
		if (element.getTagName()== "button") {
			System.out.println("Click Done on Element with Text name: "+element.getText());
		}
	}
	...
	public void afterChangeValueOf(WebElement element, WebDriver driver, CharSequence[] keysToSend) {
		//		System.out.println("Script Typed"+keysToSend.toString());
	}

	@Override
	public void beforeScript(String script, WebDriver driver) {
		System.out.println("Script Is Typing "+script.toString());}

	@Override
	public void afterScript(String script, WebDriver driver) {
		System.out.println("Script Typed "+script.toString());	}
